...
const CardUbicacion = ({icon, titulo1, titulo2, icon2, hora, parrafo, btn1, btn2 }) => (
    <div className="flex flex-col  -bottom-40 bg-white-400 justify-center items-center px-8 py-8   w-[300px] shadow-3xl">
        ...
        {hora &&
            <div className='flex p-2 items-center '>
                <img src={icon2} alt="hora" class="w-[17px] h-[17px]"/>
        ...
        {btn1 &&
            <button data-aos="zoom-in" className='bg-dark-pink p-2 w-[150px] mb-2'>{btn1}</button>
        }
        {btn2 &&
