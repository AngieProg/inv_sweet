...
export const regalos = [
  {
    ...
    parrafo:
      "Es la tradición de regalar dinero en efectivo en un sobre a la festejada el día del evento",
    datosBancarios: [
      {
        icon2: cuentaBanco,
        label: "BANCO",
  ...
  },
  {
    ...
    titulo2: "Amazon",
    parrafo:
      "Un detalle especial para la quinceañera. Entra al link para ver algunas ideas de regalos.",
    label: "VER REGALOS",
    datosBancarios: [
      {
        icon2: cuentaBanco,
  ...
  },
  {
    ...
    parrafo:
      "Si lo deseas, puedes realizar una transferencia a nuestra cuenta para dar un regalo a la quinceañera",
    datosBancarios: [
      {
        icon2: cuentaBanco,
        label: "BANCO",
